...
const Tag = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	return `<code class="${"svelte-1uycnna"}"><picture><source srcset="${"tags/" + escape(tagId) + ".webp"}" type="${"image/webp"}">
    <source srcset="${"tags/" + escape(tagId) + ".png"}" type="${"image/png"}">
    <img src="${"tags/" + escape(tagId) + ".png"}"${add_attribute("alt", `${tagString} logo`, 0)} class="${"svelte-1uycnna"}"></picture>
  <div class="${"tagLabel svelte-1uycnna"}">${escape(tagString)}</div></code>`;
});
...
const PostFilter = create_ssr_component(($$result, $$props, $$bindings, slots) => {
    ...
    <span class="${"svelte-1jw38g2"}">${each(types, typeId => `<code class="${["svelte-1jw38g2", activeTypes.has(typeId) ? "activeTags" : ""].join(" ").trim()}"><picture><source srcset="${"tags/" + escape(typeId) + ".webp"}" type="${"image/webp"}">
            <source srcset="${"tags/" + escape(typeId) + ".png"}" type="${"image/png"}">
            <img src="${"tags/" + escape(typeId) + ".png"}"${add_attribute("alt", `${tagLabels[typeId] || typeId} logo`, 0)} class="${"svelte-1jw38g2"}"></picture>
          <div class="${"tagLabel svelte-1jw38g2"}">${escape(pluralize(typeLabels[typeId]) || pluralize(typeId))}</div>
        </code>`)}</span>`
		: ``}
  ${tags.length
		? `${types.length
			...
			: `<h3 class="${"svelte-1jw38g2"}">Include</h3>`}
    <span class="${"svelte-1jw38g2"}">${each(tags, tagId => `<code class="${["svelte-1jw38g2", activeTags.has(tagId) ? "activeTags" : ""].join(" ").trim()}"><picture><source srcset="${"tags/" + escape(tagId) + ".webp"}" type="${"image/webp"}">
            <source srcset="${"tags/" + escape(tagId) + ".png"}" type="${"image/png"}">
            <img src="${"tags/" + escape(tagId) + ".png"}"${add_attribute("alt", `${tagLabels[tagId] || tagId} logo`, 0)} class="${"svelte-1jw38g2"}"></picture>
          <div class="${"tagLabel svelte-1jw38g2"}">${escape(tagLabels[tagId] || tagId)}</div>
        </code>`)}</span>`
		: ``}`
	: ``}`;
});
...
<div>${visible
    ...
    <h1 class="${"svelte-1hlexrf"}">${escape(post.title)} ${escape(post.emoji)}</h1>
    <div class="${"subtitle svelte-1hlexrf"}"><p>${post.blurb}
        ${post.collaborators
		? `<span class="${"collab svelte-1hlexrf"}">${each(post.collaborators, collab => `<a aria-label="${"collaborator"}" href="${"https://github.com/" + escape(collab) + "/"}">@${escape(collab)}</a>
               `)}</span>`
		: ``}
