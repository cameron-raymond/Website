  ...
  render() {
    return (
      <div className="caseContainer">
        ...
        <CaseText title={"impact"}>	The resulting app has a pleasant, fluid, user experience and is a simple alternative to traditional shipping measurements. Due to our team’s ethos of making better use of available space, we were awarded as one of the top 2 projects that foster sustainable cities through the use of AI by TELUS. </CaseText>
