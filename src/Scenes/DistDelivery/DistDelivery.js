  ...
  render() {
    return (
      <div className="caseContainer">
        ...
        <CaseText title={"problem"}>There are 33.8 million vehicles in Canada, and 100+ million parcels delivered each year. Our team at QHacks 2019 wannted to access the untapped wealth of trunk space to meet a need cheap shipping alternatives. Distributed Deliveries is a platform that takes advantage of the trend in sharing economies by pairing users who need items shipped, with drivers already going in that direction.</CaseText>
