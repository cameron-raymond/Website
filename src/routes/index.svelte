  ...
  {#if visible && onHome}
    <div class="intro">
      ...
      <p
        ...
        out:fly={{ y: 50, duration: 500 }}>
        Currently a computational social science RA at the University of Toronto, and owner of the blog <a aria-label="Networkd" href="https://medium.com/networkd">Networkd</a>. 
      </p>
    </div>
    <span
